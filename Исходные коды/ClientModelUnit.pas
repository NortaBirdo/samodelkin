...
type
  ...
  var
    ...
    procedure AddClient;
    function IsModifiedClient: boolean;
...
procedure TClientModel.AddClient;
begin
  ADQueryClients.Insert
end;
...
function TClientModel.IsModifiedClient: boolean;
begin
  result := ADQueryClients.Modified
end;
...
procedure TClientModel.SaveClient;
begin
  ADQueryClients.Post;
end;
